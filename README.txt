...
Limitation:
The program couldn't print different searched trials of path in the scenario of no solution. It can only be done in the scenario of a solution was found. When there was no solution, I can only print the whole path it searched.
